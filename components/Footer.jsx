...
function Footer() {
    ...
    <footer className="mt-48 relative bg-secondaryBgLight dark:bg-secondaryBgDark duration-150">
        <div className="custom-shape-divider-top-1706264669 duration-150">
        <svg  data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
        <path className="duration-150 shape-fill" fill={fillColor} d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V0H0V27.35A600.21,600.21,0,0,0,321.39,56.44Z" ></path>
        </svg>
        </div>
        <div className="mx-auto w-full max-w-screen-xl pt-32 lg:pt-48 pb-8 lg:pb-12  ">
            ...
            <div className="flex flex-col justify-start items-start mx-auto px-20">
                <div className='flex gap-4'>
                    ...
                    <p className='text-xl md:text-2xl text-secondaryTextLight dark:text-secondaryTextDark hover:text-primaryBgDark dark:hover:text-primaryBgLight'>This is the email</p>
                </div>
